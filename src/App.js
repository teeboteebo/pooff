      ...
      <Router>
        {!loading ?
          <div
            ...
            <div className="flip-msg">
              <p>Vänligen räta upp enheten till stående läge</p>
              <img src="/images/logos/pooff-dark.png" className="flip-logo" alt="pooff-logo"/>
            </div>
            <main>
